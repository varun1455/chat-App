...
const ChatRoom = () => {
  ...
  return (
    <div className="py-4 m-5 w-50 shadow bg-dark text-dark border rounded container chatbox">
      <div className="text-center px-3 mb-4 text-capitalize">
        <h1 className="text-success mb-4">Live Box</h1>
      </div>
      <div
        ...
        {allMessages.map((msg) => {
          return data.name === msg.name ? (
            ...
            <div className="row justify-content-start">
              <div className="d-flex flex-column m-2 p-2 shadow bg-dark border rounded w-auto">
                <div>
                  <strong className="m-1">{msg.name}</strong>
